...
[Fs, s] = wavfile.read('./samples/like_themes/track_3_mono.wav')
...
wavfile.write("samples/music_44100_with_tempo.wav", Fs, np.int16(s))
# play the generated file in notebook:
IPython.display.display(IPython.display.Audio("samples/music_44100_with_tempo.wav"))